...
export default function Home() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      <section className="relative min-h-[calc(100vh-4rem)] flex items-center px-4 py-12 sm:py-16 overflow-hidden">
        <div
          className={`absolute inset-0 transition-colors duration-500 ${
            isLight
              ? "bg-gradient-to-b from-blue-50/80 via-white to-slate-50/90"
              : "bg-gradient-to-b from-[#040913]/95 via-[#060d1a]/95 to-[#030710]/100"
          }`}
        />
        ...
        <div
          ref={heroRef}
          className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 opacity-0 translate-y-6 transition-all duration-700 ease-out"
        >
          <div className="max-w-3xl">
            <div
              className={`inline-flex items-center gap-2 px-4 py-2 rounded border mb-6 transition-colors duration-300 ${
                isLight
                  ...
                  : "border-amber-400/60 bg-amber-400/10 shadow-[0_0_22px_rgba(234,179,8,0.16)]"
              }`}
            >
              <SparkleIcon size={16} className="text-amber-300" />
              <span className="font-sans text-xs text-amber-300 font-semibold tracking-[0.16em] uppercase">
                Performance Grade UI
              </span>
            </div>

            <h1
              className="font-display text-4xl sm:text-5xl md:text-5xl font-bold
                         text-stone-100 leading-tight mb-6 text-left max-w-3xl"
            >
            ...
            <p className="font-body text-lg sm:text-xl text-stone-300 max-w-2xl leading-relaxed mb-10 text-left">
            ...
            <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl">
              {[
                ...
                <div
                  key={stat.label}
                  className="text-left group cursor-default hover:scale-[1.03] transition-transform duration-300"
                >
                  <p className="font-display text-2xl sm:text-3xl font-bold text-emerald-300 mb-1 group-hover:text-emerald-200 transition-colors">
                    {stat.value}
                  </p>
              ...
              <Link
                ...
                className={`card hover:scale-[1.04] hover:-translate-y-1 transition-all duration-300 group ${
                  isLight
                    ...
                    : "border-mountain-600/40 hover:border-saffron-500/45"
                }`}
              >
                <div
        ...
        <div
          className={`card text-center py-12 hover:scale-[1.01] transition-all duration-300 ${
            isLight
              ...
              : "border-emerald-400/40 bg-gradient-to-br from-emerald-500/12 via-sky-500/8 to-amber-400/8"
          }`}
        >
          <MountainsIcon
            size={48}
          ...
          <p className="font-body text-stone-400 max-w-lg mx-auto leading-relaxed mb-6">
            Join Yaatra Saathi today and access the complete pilgrimage
            companion — AI guide, route maps, and a community of fellow
            pilgrims.
          </p>
          <Link
            to="/register"
