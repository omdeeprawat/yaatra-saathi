...
import { Mountain, MessageSquare, Map as MapIcon, Users, Sparkles, ArrowRight } from 'lucide-react';
    ...
    <div className="overflow-x-hidden">
          ...
          <div className="mt-16 grid grid-cols-3 gap-6 max-w-2xl mx-auto">
            {[
              ...
              <div key={stat.label} className="text-center">
                <p className="text-2xl sm:text-3xl font-bold text-saffron-400 mb-1">
                  {stat.value}
                </p>
      ...
      <section className="max-w-6xl mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <span className="text-sm text-saffron-400 uppercase tracking-widest">
            Features
          </span>
          <h2 className="text-3xl text-stone-100 mt-2">
          ...
          {[
            {
              ...
              desc: 'Chat with an AI trained on the pilgrimage knowledge base.',
              to: '/chat',
            ...
            },
            {
              ...
              desc: 'Explore the full journey on a 3D terrain map.',
              to: '/map',
            ...
            },
            {
              ...
              desc: 'Connect with fellow pilgrims and share experiences.',
              to: '/feed',
      ...
      <section className="max-w-4xl mx-auto px-4 py-16">
        <div className="card border-saffron-500/30 bg-gradient-to-br from-saffron-500/10
          ...
          <Mountain className="w-12 h-12 text-saffron-400 mx-auto mb-4" />
          <h2 className="text-2xl text-stone-100 mb-3">
            Ready to Begin Your Journey?
          </h2>
          <p className="text-stone-400 max-w-lg mx-auto leading-relaxed mb-6">
            Join Yatra Saathi today and access your pilgrimage companion.
          </p>
