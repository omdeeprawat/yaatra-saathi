    ...
    >
      <div className="bg-mountain-900 border border-mountain-600/60 rounded-xl shadow-2xl overflow-hidden w-72">
        <div className="flex items-start justify-between p-4 pb-3 border-b border-mountain-700/50">
          <div>
            <div
              className={`inline-flex items-center gap-1.5 text-xs font-sans font-medium px-2 py-0.5 rounded-full border mb-2
          ...
          {[
            {
              icon: Mountain,
              label: "Altitude",
              value: `${stop.altitude_meters.toLocaleString()}m`,
            },
            {
              icon: TrendingUp,
              label: "Stage",
              value: `Day ${stop.stage_number}`,
            },
            {
              icon: Route,
              label: "Total km",
              value: `${stop.cumulative_km}km`,
            },
            ...
            >
              ...
              <span className="font-sans text-xs font-semibold text-stone-200">
                {value}
              </span>
              <span className="font-sans text-[10px] text-stone-600 uppercase tracking-wide">
                {label}
              </span>
            </div>
          ))}
